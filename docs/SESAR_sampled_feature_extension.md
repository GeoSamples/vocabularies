...
subtitle: 
  ...
  Terms to categorize sampled features in more detail. This vocabulary extends the iSamples Sampled Feature Type vocabulary with concepts from the GeoSciML event environment vocabulary, and adds several additional concepts.
...
[]{#high_pressure_low_temperature_earth_interior}

#####  High-pressure low-temperature earth interior
- **Child of**:
 [`Earth interior`](#earthinterior)
- High pressure environment characterized by geothermal gradient
significantly lower than standard continental geotherm, enviornment in
...
- **Source:**
http://resource.geosciml.org/classifierscheme/cgi/2016.01/eventenvironment
- **Concept URI:** https://w3id.org/sesar/sampledfeature/high_pressure_low_temperature_earth_interior
- **Other Properties:**
...
- **Child of**:
 ...
 [`Volcanic Setting`](#volcanic_setting)
-
- A physiographic feature formed by eruption of magma from one or a
small set of vents or fissures; typically thought to be associated
with a single magmatic system
- **Source:**
SESAR legacy localities
...
- **Child of**:
 [`Earth environment`](#earthenvironment)
-
- Features associated with the generatation, movement, intrusion,
extrusion, or crystallization of magma.
- **Source:**
SESAR legacy localities
...
######  Lava flow
- **Child of**:
 [`Volcanic complex`](#volcanic_complex)
 [`Volcanic Setting`](#volcanic_setting)
-
- **Source:**
SESAR legacy localities
- **Concept URI:** https://w3id.org/sesar/sampledfeature/lava_flow
- **Other Properties:**
