...
#    command = 'uijson'
    path = '../docs'
# *******************
    input1 = "SESAR_sampled_feature_extension|SESAR_material_extension_rock_sediment|SamplingMethods"
...
# vocab_source_dir is the path to the directory that contains the source files
    ...
    input1 = "sessf:sfvocabulary|sesrs:rocksedimentvocabulary|secm:samplingmethods"
